...
export default function StartupGuidesCategoryPage() {
  ...
  const highlights = [
    { label: "120+ In-Depth Guides", icon: "📖" },
    { label: "25K+ Entrepreneurs", icon: "👥" },
    { label: "Weekly New Guides", icon: "📅" },
    { label: "Expert Contributors", icon: "🌟" },
  ];

  const posts = [
    {
      title: "The Ultimate Startup Launch Checklist for First-Time Founders",
      category: "Getting Started",
      desc: "A complete step-by-step checklist to go from idea to launch with confidence.",
      date: "May 18, 2024",
    ...
    },
    {
      ...
      desc: "Avoid building something nobody wants. Learn proven ways to validate your idea early.",
      date: "May 14, 2024",
      readTime: "8 min read",
      author: "Neha Verma",
    },
    {
      title: "Startup Funding 101: Bootstrapping vs. Raising Capital",
      category: "Funding",
      desc: "Understand your options and choose the right funding path for your startup.",
      date: "May 10, 2024",
      readTime: "9 min read",
      author: "Amit Patel",
    },
    {
      title: "MVP Development Guide: Build, Test & Iterate Faster",
      category: "Build & Launch",
      desc: "Build a Minimum Viable Product that solves real problems and gets real users.",
      date: "May 6, 2024",
      readTime: "7 min read",
      author: "Karan Mehta",
    },
    {
      title: "10 Growth Strategies That Actually Work for Startups",
      category: "Growth & Scaling",
      desc: "Proven strategies to acquire more users, increase revenue, and scale sustainably.",
      date: "May 2, 2024",
      readTime: "8 min read",
      author: "Priya Singh",
    },
    {
      title: "Entrepreneur Mindset: 7 Habits of Successful Founders",
      category: "Mindset",
      desc: "Build the right mindset to overcome challenges and achieve long-term success.",
      date: "Apr 28, 2024",
      readTime: "6 min read",
      author: "Sneha Iyer",
    }
  ...
  const popularArticles = [
    { title: "The Ultimate Startup Launch Checklist", date: "May 18, 2024" },
    { title: "How to Validate Your Startup Idea Before Building", date: "May 14, 2024" },
    { title: "Startup Funding 101: Bootstrapping vs. Raising Capital", date: "May 10, 2024" },
    { title: "MVP Development Guide: Build, Test & Iterate Faster", date: "May 6, 2024" },
    { title: "10 Growth Strategies That Actually Work for Startups", date: "May 2, 2024" }
  ];

  const tags = [
    "Lean Startup", "Business Model", "Pitch Deck", "Go-to-Market", "Product Strategy", "Fundraising", "MVP", "Growth Hacking", "Team Building", "Startup Tools", "Legal", "Finance"
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">Startup Guides</span>
          </nav>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <p className="text-sm md:text-base text-text-muted leading-relaxed max-w-xl mb-8">
                Step-by-step guides, actionable frameworks, and expert advice to help you start, build, and scale your startup.
              </p>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Ideation & Validation</span><span className="text-primary font-bold">Validated Strategy</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>MVP Building</span><span className="text-primary font-bold">2-6 Weeks Release</span>
                  </div>
                </div>
                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">Your Startup Journey</span>
                    <span className="font-bold font-serif text-white mt-1">Status: Product Launched</span>
                  </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6 text-left w-full">
              ...
              <div className="hog-card rounded-3xl p-6 md:p-8 bg-[#0B0F19] text-white border border-border-custom flex flex-col gap-4">
                ...
                <p className="text-[10px] text-white/70 leading-relaxed">
                  From idea to IPO – we cover every step of your startup journey. Practical guides, frameworks, templates, and expert insights to help you build something people love.
                </p>
                <Link href="/services/mvp-development" className="inline-flex items-center gap-1 text-[10px] font-mono font-bold text-primary hover:underline">
              ...
              <div className="hog-card rounded-3xl p-6 md:p-8 bg-card-bg/60 border border-border-custom flex flex-col gap-4">
                ...
                <p className="text-[10px] text-text-muted leading-relaxed">
                  Get actionable startup tips and guides straight to your inbox every week.
                </p>
