...
export default function SoftwareDevelopmentCategoryPage() {
  ...
  const highlights = [
    { label: "150+ Articles", icon: "📄" },
    { label: "30K+ Developers", icon: "👥" },
  ...
  const posts = [
    {
      title: "Clean Code: 10 Principles Every Developer Should Follow",
      category: "Tools & Productivity",
      desc: "Write code that is easy to read, maintain, and scale. Let&apos;s look at the essential principles of clean code.",
      date: "May 18, 2024",
      readTime: "8 min read",
      author: "Rohit Sharma",
      featured: true,
    ...
    {
      title: "REST APIs vs GraphQL: Which One Should You Choose?",
      category: "Backend",
      desc: "A detailed comparison to help you choose the right API architecture for your next project.",
      date: "May 12, 2024",
      readTime: "6 min read",
      author: "Neha Verma",
    },
    {
      ...
      category: "Frontend",
      desc: "Improve the performance of your React applications with these practical tips and best practices.",
      date: "May 8, 2024",
      readTime: "7 min read",
      author: "Amit Patel",
    },
    {
      ...
      category: "DevOps",
      desc: "Learn the fundamentals of Docker and how it can simplify your development workflow.",
      date: "May 5, 2024",
      readTime: "9 min read",
      author: "Karan Mehta",
    },
    {
      title: "Getting Started with Flutter in 2024",
      category: "Mobile Development",
      desc: "A beginner-friendly guide to build cross-platform apps using Flutter and Dart.",
      date: "Apr 28, 2024",
      readTime: "6 min read",
      author: "Priya Singh",
    },
    {
      title: "Unit Testing in JavaScript with Jest: Best Practices",
      category: "Testing",
      desc: "Learn how to write effective and maintainable unit tests using Jest.",
      date: "Apr 22, 2024",
      readTime: "7 min read",
      author: "Sneha Iyer",
    }
  ...
  const popularArticles = [
    { title: "Clean Code: 10 Principles Every Developer Should Follow", date: "May 18, 2024" },
    { title: "REST APIs vs GraphQL: Which One Should You Choose?", date: "May 12, 2024" },
    { title: "React Performance Optimization: Tips and Techniques", date: "May 8, 2024" },
    { title: "Docker for Developers: A Practical Guide", date: "May 5, 2024" },
    { title: "Top 10 VS Code Extensions to Boost Productivity", date: "Apr 20, 2024" }
  ];

  const tags = [
    "JavaScript", "Python", "React", "Node.js", "TypeScript", "Next.js", "DevOps", "Docker", "AWS", "Testing", "Git", "CI/CD", "System Design"
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">Software Development</span>
          </nav>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <p className="text-sm md:text-base text-text-muted leading-relaxed max-w-xl mb-8">
                Best practices, tutorials, tools, and industry insights to help developers build better software and scalable applications.
              </p>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Clean Code</span><span className="text-primary font-bold">10 Principles</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>API Architectures</span><span className="text-primary font-bold">REST vs GraphQL</span>
                  </div>
                </div>
                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">System Status</span>
                    <span className="font-bold font-serif text-white mt-1">Docker Environment Active</span>
                  </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6 text-left w-full">
              ...
              <div className="hog-card rounded-3xl p-6 md:p-8 bg-[#0B0F19] text-white border border-border-custom flex flex-col gap-4">
                ...
                <p className="text-[10px] text-white/70 leading-relaxed">
                  Software development is constantly evolving. Explore in-depth tutorials, best practices, industry trends, and tools to level up your development skills.
                </p>
                <Link href="/services/custom-software-development" className="inline-flex items-center gap-1 text-[10px] font-mono font-bold text-primary hover:underline">
              ...
              <div className="hog-card rounded-3xl p-6 md:p-8 bg-card-bg/60 border border-border-custom flex flex-col gap-4">
                ...
                <p className="text-[10px] text-text-muted leading-relaxed">
                  Get the latest software development insights and articles straight to your inbox.
                </p>
