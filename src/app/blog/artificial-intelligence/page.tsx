...
export default function ArtificialIntelligenceCategoryPage() {
  ...
  const posts = [
    {
      ...
      desc: "Understand the fundamentals of AI, its key components, types, and real-world examples.",
      date: "May 15, 2024",
      readTime: "8 min read",
      author: "Rohit Sharma",
      featured: true,
    ...
    {
      title: "Top 10 AI Trends to Watch in 2024 and Beyond",
      category: "Machine Learning",
      desc: "Discover the most impactful AI trends that businesses and developers should keep an eye on.",
      date: "May 10, 2024",
      readTime: "6 min read",
      author: "Neha Verma",
    },
    {
      ...
      desc: "A detailed comparison to help you understand when and how to use each approach.",
      date: "May 5, 2024",
      readTime: "7 min read",
      author: "Amit Patel",
    },
    {
      ...
      category: "Machine Learning",
      desc: "Explore real-world use cases of AI driving innovation and efficiency.",
      date: "Apr 28, 2024",
      readTime: "6 min read",
      author: "Priya Singh",
    },
    {
      title: "A Beginner's Roadmap to Learn Artificial Intelligence in 2024",
      category: "NLP",
      desc: "Step-by-step roadmap and resources to start your AI journey.",
      date: "Apr 20, 2024",
      readTime: "5 min read",
      author: "Karan Mehta",
    },
    {
      title: "Natural Language Processing (NLP): Applications & Use Cases",
      category: "NLP",
      desc: "How NLP is powering smart chatbots, search engines, translation tools, and more.",
      date: "Apr 15, 2024",
      readTime: "7 min read",
      author: "Sneha Iyer",
    }
  ...
  const popularArticles = [
    { title: "What is Artificial Intelligence? A Complete Guide", date: "May 15, 2024" },
    { title: "Top AI Tools for Developers in 2024", date: "May 8, 2024" },
    { title: "How AI is Improving Customer Experience", date: "Apr 30, 2024" },
    { title: "Generative AI: Models, Applications & Future", date: "Apr 22, 2024" },
    { title: "AI Ethics: Challenges and Best Practices", date: "Apr 12, 2024" }
  ];

  const tags = [
    "AI Basics", "Machine Learning", "Deep Learning", "NLP", "Computer Vision", "Generative AI", "AI Applications", "AI Ethics"
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">Artificial Intelligence</span>
          </nav>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <p className="text-sm md:text-base text-text-muted leading-relaxed max-w-xl mb-8">
                Explore the latest insights, trends, tutorials, and real-world applications of Artificial Intelligence and how it&apos;s transforming industries.
              </p>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Machine Learning</span><span className="text-primary font-bold">Enabled</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>NLP & Vision</span><span className="text-primary font-bold">Active</span>
                  </div>
                </div>
                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">Cognitive Processing</span>
                    <span className="font-bold font-serif text-white mt-1">Generative AI Active</span>
                  </div>
            ...
            <div className="lg:col-span-4 flex flex-col gap-6 text-left w-full">
              ...
              <div className="hog-card rounded-3xl p-6 md:p-8 bg-[#0B0F19] text-white border border-border-custom flex flex-col gap-4">
                ...
                <p className="text-[10px] text-white/70 leading-relaxed">
                  Artificial Intelligence is reshaping the future. Stay updated with expert insights, tutorials, and the latest breakthroughs in AI.
                </p>
                <Link href="/services/ai-development" className="inline-flex items-center gap-1 text-[10px] font-mono font-bold text-primary hover:underline">
                  <span>Learn More About Our AI Services</span>
                  <ArrowRight className="size-3.5" />
                </Link>
              </div>
              ...
              <div className="hog-card rounded-3xl p-6 md:p-8 bg-card-bg/60 border border-border-custom flex flex-col gap-4">
                ...
                <p className="text-[10px] text-text-muted leading-relaxed">
                  Get the latest AI insights and articles straight to your inbox.
                </p>
