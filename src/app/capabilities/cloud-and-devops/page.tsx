...
import { ArrowRight, Code, Layers, ShieldCheck, Heart, Clock, Compass, ClipboardList, Layout, CheckSquare, Rocket, MessageSquare, Lock, Cloud, Settings, Server, Activity, ShieldAlert } from "lucide-react";

export default function CloudAndDevOpsPage() {
  const serviceStats = [
    { label: "Scalable & Flexible", icon: <Layers className="size-4 text-primary" />, desc: "Scale as you grow" },
    { label: "Highly Secure", icon: <Lock className="size-4 text-primary" />, desc: "Enterprise-grade security" },
    { label: "Cost Optimized", icon: <Server className="size-4 text-primary" />, desc: "Pay for what you use" },
    { label: "High Availability", icon: <Activity className="size-4 text-primary" />, desc: "99.99% uptime focus" },
  ];

  const offers = [
    {
      title: "Cloud Infrastructure",
      description: "Design, deploy, and manage scalable and secure cloud infrastructure on AWS, Azure, GCP, and more.",
      icon: <Cloud className="size-6 text-primary" />,
    },
    {
      title: "CI/CD Pipeline Automation",
      description: "Automate build, test, and deployment processes to deliver faster and more reliable software.",
      icon: <Settings className="size-6 text-primary" />,
    },
    {
      title: "Infrastructure as Code",
      description: "Manage infrastructure using code for consistency, versioning, and repeatability.",
      icon: <Code className="size-6 text-primary" />,
    },
    {
      title: "Cloud Security & Compliance",
      description: "Implement best practices for security, compliance, and identity management in the cloud.",
      icon: <Lock className="size-6 text-primary" />,
    },
    {
      title: "Monitoring & Observability",
      description: "Real-time monitoring, logging, and alerting to ensure system health and performance.",
      icon: <Activity className="size-6 text-primary" />,
    },
    {
      title: "Containerization (Docker/K8s)",
      description: "Containerize applications and orchestrate with Kubernetes for scalability and portability.",
      icon: <Layers className="size-6 text-primary" />,
    },
    {
      title: "Serverless Solutions",
      description: "Build and run applications without managing servers for maximum agility and cost-efficiency.",
      icon: <Rocket className="size-6 text-primary" />,
    },
    {
      title: "Cloud Cost Optimization",
      description: "Optimize resource usage and reduce cloud costs without compromising performance.",
      icon: <Server className="size-6 text-primary" />,
    },
  ];

  const steps = [
    { id: "01", name: "Plan", desc: "We analyze your requirements and infrastructure needs.", icon: <Compass className="size-5 text-primary" /> },
    { id: "02", name: "Code", desc: "Develop with best practices and version control.", icon: <Code className="size-5 text-primary" /> },
    { id: "03", name: "Build & Test", desc: "Automate builds and testing for quality assurance.", icon: <CheckSquare className="size-5 text-primary" /> },
    { id: "04", name: "Deploy", desc: "Deploy to cloud with automated pipelines.", icon: <Rocket className="size-5 text-primary" /> },
    { id: "05", name: "Monitor", desc: "Monitor, log, and optimize for continuous improvement.", icon: <Activity className="size-5 text-primary" /> },
    { id: "06", name: "Optimize", desc: "Iterate and optimize for performance, cost & reliability.", icon: <Settings className="size-5 text-primary" /> },
  ];

  const whyChoose = [
    { title: "Cloud Experts", desc: "Certified professionals with hands-on experience across major cloud platforms.", icon: <CloudIcon className="size-5 text-primary" /> },
    { title: "Automation First", desc: "We automate everything so you can focus on what matters most.", icon: <Settings className="size-5 text-primary" /> },
    { title: "Reliable & Secure", desc: "Built with security, compliance, and reliability at the core.", icon: <Lock className="size-5 text-primary" /> },
    { title: "24/7 Support", desc: "Round-the-clock support to keep your systems running smoothly.", icon: <Clock className="size-5 text-primary" /> },
  ];
  ...
  const recentProjects = [
    { id: "eduplatform", title: "EduPlatform", tag: "AWS", desc: "Scalable LMS platform deployed on AWS with auto-scaling, CI/CD, and monitoring.", icon: "🎓" },
    { id: "fintrack", title: "FinTrack", tag: "Azure", desc: "Finance dashboard with secure infrastructure, automated deployments, and monitoring.", icon: "💳" },
    { id: "shopkart", title: "ShopKart", tag: "GCP", desc: "E-commerce application on GCP with Kubernetes, Cloud SQL, and CI/CD pipelines.", icon: "🛒" },
    { id: "healthplus", title: "HealthPlus", tag: "AWS", desc: "Healthcare app with HIPAA-ready infrastructure, backups, and high availability.", icon: "🩺" },
  ];

  const schemaNodes = [
    { title: "Cloud Infrastructure", icon: <Cloud className="size-5 text-primary" />, x: -120, y: -90 },
    { title: "CI/CD Automation", icon: <Settings className="size-5 text-primary" />, x: 120, y: -90 },
    { title: "Security & Compliance", icon: <Lock className="size-5 text-primary" />, x: -120, y: 0 },
    { title: "Monitoring & Observability", icon: <Activity className="size-5 text-primary" />, x: 120, y: 0 },
    { title: "Infrastructure as Code", icon: <Code className="size-5 text-primary" />, x: -120, y: 90 },
    { title: "Performance Optimization", icon: <Rocket className="size-5 text-primary" />, x: 120, y: 90 },
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">Cloud & DevOps</span>
          </nav>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start">
              ...
              <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-text-base leading-[1.08] mb-6">
                Scalable Cloud Solutions. Automated for Performance.{" "}
            ...
            <div className="lg:col-span-5 w-full flex justify-center">
              <div className="relative w-full max-w-[420px] aspect-square flex items-center justify-center p-8 select-none">
                ...
                <div className="relative z-10 size-24 rounded-2xl bg-neutral-900 border border-white/10 flex flex-col items-center justify-center shadow-lg text-center p-2">
                  <Cloud className="size-7 text-primary animate-pulse" />
                  <span className="text-[10px] font-mono text-white mt-1 uppercase tracking-widest leading-none">Cloud & DevOps</span>
                </div>
                ...
                {schemaNodes.map((node, i) => (
                  ...
                  >
                    <div className="flex flex-col items-center gap-1 p-2 rounded-xl bg-white dark:bg-[#111827] border border-border-custom shadow-sm min-w-[100px] text-center">
                      <div className="size-8 rounded-full border border-border-custom bg-card-bg flex items-center justify-center">
                        {node.icon}
                      </div>
          ...
          <section className="py-8 relative border-t border-border-custom/30 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-sm md:text-base text-text-muted mt-2">
                End-to-end cloud and DevOps solutions to modernize your infrastructure, automate workflows, and deliver faster.
              </p>
            </div>
          ...
          <section className="py-8 relative border-t border-border-custom/30 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-sm md:text-base text-text-muted mt-2">
                A proven DevOps approach to deliver high-quality applications faster and with confidence.
              </p>
            </div>
          ...
          <section className="py-8 relative border-t border-border-custom/30 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-text-base mt-2">
                Your Cloud. Our Expertise. Your Competitive Edge.
              </h2>
              <p className="text-sm md:text-base text-text-muted mt-2">
                We combine expertise with DevOps automation to help you innovate faster, scale smarter, and stay ahead of the competition.
              </p>
            </div>
          ...
          <section className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[#0B0F19] px-8 py-16 md:py-20 text-center shadow-lg">
            ...
            <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
              <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-white mb-4 leading-tight">
                Ready to Migrate, Modernize & Scale?
              </h2>

              <p className="text-xs md:text-sm text-white/70 max-w-lg mb-8 leading-relaxed">
                Let&apos;s build a cloud-native, automated, and future-ready infrastructure for your business. Book a free consultation today!
              </p>
...
function CloudIcon(props: React.SVGProps<SVGSVGElement>) {
  return (
    ...
    >
      <path d="M17.5 19A3.5 3.5 0 0 0 21 15.5c0-2.79-2.54-4.5-5-4.5-.42 0-.83.04-1.24.12A7 7 0 0 0 2 9c0 3.31 2.69 6 6 6h9.5z" />
    </svg>
  );
}
