...
import { ArrowRight, Code, Layers, ShieldCheck, Heart, Clock, Compass, ClipboardList, Layout, CheckSquare, Rocket, MessageSquare, Lock, Eye, Palette, Search, Compass as CompassIcon, Tablet, Monitor } from "lucide-react";
...
export default function UIUXDesignPage() {
  ...
  const offers = [
    {
      title: "User Research",
      description: "We understand your users, their needs, behaviors, and pain points through in-depth research.",
      icon: <Search className="size-6 text-primary" />,
    },
    {
      title: "UI/UX Design",
      description: "Beautiful, intuitive, and functional designs that deliver exceptional user experiences.",
      icon: <Palette className="size-6 text-primary" />,
    },
    {
      title: "Mobile App Design",
      description: "Engaging and user-friendly mobile app designs for iOS and Android platforms.",
      icon: <Tablet className="size-6 text-primary" />,
    },
    {
      title: "Web Design",
      description: "Modern, responsive website designs that reflect your brand and drive conversions.",
      icon: <Monitor className="size-6 text-primary" />,
    },
    {
      title: "Wireframing & Prototyping",
      description: "Low to high-fidelity wireframes and interactive prototypes to validate ideas early.",
      icon: <Layout className="size-6 text-primary" />,
    },
    {
      title: "Design System",
      description: "Scalable design systems and component libraries for consistency and speed.",
      icon: <Layers className="size-6 text-primary" />,
    },
    {
      title: "Usability Testing",
      description: "We test designs with real users to ensure usability, accessibility, and effectiveness.",
      icon: <CheckSquare className="size-6 text-primary" />,
    },
    {
      title: "Brand & Visual Design",
      description: "Strong visual identities and brand-aligned designs that make your product stand out.",
  ...
  const steps = [
    ...
    { id: "02", name: "Define", desc: "We research and define user needs, problems, and opportunities.", icon: <ClipboardList className="size-5 text-primary" /> },
    { id: "03", name: "Ideate", desc: "We create user flows, wireframes, and concepts.", icon: <Palette className="size-5 text-primary" /> },
    { id: "04", name: "Design", desc: "We craft beautiful UI and interactive prototypes.", icon: <Layout className="size-5 text-primary" /> },
    { id: "05", name: "Test", desc: "We test with real users, iterate, and refine the design.", icon: <CheckSquare className="size-5 text-primary" /> },
    { id: "06", name: "Deliver", desc: "We hand over pixel-perfect designs and guidelines.", icon: <Rocket className="size-5 text-primary" /> },
  ];

  const whyChoose = [
    { title: "User First", desc: "We create intuitive, user-friendly experiences, not assumptions.", icon: <UsersIcon className="size-5 text-primary" /> },
    { title: "Business Focused", desc: "Every design decision supports your goals and outcomes.", icon: <Layers className="size-5 text-primary" /> },
  ...
  const recentProjects = [
    { id: "fintrack", title: "FinTrack Dashboard", tag: "Fintech", desc: "Personal finance dashboard with analytics and insights.", icon: "📊" },
    { id: "medcare", title: "MedCare App", tag: "Healthcare", desc: "Telemedicine app design for better patient experience.", icon: "🩺" },
    { id: "edusphere", title: "EduSphere Platform", tag: "Education", desc: "E-learning platform with engaging user experience.", icon: "🎓" },
    { id: "shopease", title: "ShopEase", tag: "E-commerce", desc: "Modern shopping experience with clean UI & UX.", icon: "🛒" },
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">UI/UX Design</span>
          </nav>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-5 w-full flex justify-center">
              <div className="relative w-full max-w-[420px] aspect-square flex items-center justify-center p-8 select-none">
                ...
                {/* Floating bubble */}
                <div className="absolute bottom-4 left-4 p-3 rounded-2xl bg-white dark:bg-[#111827] border border-border-custom shadow-md max-w-[160px] text-center">
                  <span className="text-[9px] font-serif font-bold text-text-base leading-snug">Design that connects. Experience that converts.</span>
                </div>
              </div>
            </div>
          ...
          <section className="py-8 relative border-t border-border-custom/30 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-sm md:text-base text-text-muted mt-2">
                End-to-end design solutions that create meaningful experiences for your users and measurable impact for your business.
              </p>
            </div>
          ...
          <section className="py-8 relative border-t border-border-custom/30 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-text-base mt-2">
                A Human-Centered Process for Exceptional Digital Experiences
              </h2>
            </div>
          ...
          <section className="py-8 relative border-t border-border-custom/30 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-sm md:text-base text-text-muted mt-2">
                We combine creativity, strategy, and empathy to design experiences that people love and businesses trust.
              </p>
            </div>
          ...
          <section className="relative overflow-hidden rounded-[32px] border border-white/10 bg-[#0B0F19] px-8 py-16 md:py-20 text-center shadow-lg">
            ...
            <div className="relative z-10 max-w-2xl mx-auto flex flex-col items-center">
              <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-white mb-4 leading-tight">
                Ready to Design Experiences That Users Love?
              </h2>

              <p className="text-xs md:text-sm text-white/70 max-w-lg mb-8 leading-relaxed">
                Let&apos;s create intuitive, beautiful, and impactful designs that bring your vision to life. Book a free consultation today!
              </p>
...
// Simple helper icon replacements
