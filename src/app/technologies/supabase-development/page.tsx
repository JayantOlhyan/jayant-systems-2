...
export default function SupabaseDevelopmentPage() {
  const indicators = [
    { label: "Open Source & Self-Hosted Option" },
    { label: "PostgreSQL Power" },
  ...
  const whyChoose = [
    {
      ...
      desc: "Ship features faster with ready-to-use backend infrastructure.",
      icon: "🚀"
    },
    {
      title: "Secure by Default",
      desc: "Row Level Security, JWT auth, and strong access controls.",
      icon: "🔒"
    },
    {
      title: "PostgreSQL Power",
      desc: "Leverage the reliability and advanced features of PostgreSQL.",
      icon: "🗄️"
    },
    {
      title: "Real-time Ready",
      desc: "Built-in real-time subscriptions for live experiences.",
      icon: "🔄"
    },
    {
      title: "Open Source",
      desc: "Open, transparent, and self-hostable. No vendor lock-in.",
      icon: "🌱"
    },
    {
      title: "Cost Effective",
      desc: "More affordable than traditional BaaS platforms.",
      icon: "💰"
    }
  ];
  ...
  const services = [
    {
      title: "Backend Setup & Architecture",
      desc: "Design and set up scalable Supabase backends from scratch.",
      icon: "🛠️"
    },
    {
      title: "Authentication Solutions",
      desc: "Implement secure auth flows with email, OAuth, magic links & more.",
      icon: "🔒"
    },
    {
      title: "Database Design & Optimization",
      desc: "Design normalized schemas, indexes, and policies for best performance.",
      icon: "🗄️"
    },
    {
      title: "Real-time Features",
      desc: "Build real-time apps with subscriptions, presence, and live data sync.",
      icon: "🔄"
    },
    {
      title: "Storage Solutions",
      desc: "File uploads, access policies, CDN delivery & secure storage.",
      icon: "📁"
    },
    {
      title: "Edge Functions Development",
      desc: "Custom business logic with Deno-based edge functions.",
      icon: "⚙️"
    }
  ];

  const techWeUse = [
    "Supabase", "React", "Next.js", "Flutter", "TypeScript", "Tailwind CSS", "Deno", "PostgreSQL", "Docker"
  ];

  const pillars = [
    "Expert Supabase Developers",
    "On-Time Delivery",
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">Supabase Development</span>
          </nav>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Authentication</span><span className="text-primary font-bold">Secure Auth Ready</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Database</span><span className="text-primary font-bold">PostgreSQL / RLS Enabled</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Real-time</span><span className="text-primary">Subscriptions Active</span>
                  </div>
                </div>

                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">Edge Functions</span>
                    <span className="font-bold font-serif text-white mt-1">Status: Open Source & Scalable</span>
                  </div>
          ...
          <section className="py-8 border-t border-border-custom/25 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-text-base mt-2">
                Why Choose Supabase for Your Project?
              </h2>
              <p className="text-xs md:text-sm text-text-muted leading-relaxed mt-4">
                Supabase gives you the backend you need to build amazing products—faster.
              </p>
            </div>
          ...
          {/* Technologies We Use with Supabase */}
          <section className="py-8 border-t border-border-custom/25 pt-16 text-center">
            <h3 className="font-serif text-2xl font-bold text-text-base mb-8">Technologies We Use with Supabase</h3>
