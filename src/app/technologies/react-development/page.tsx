...
export default function ReactDevelopmentPage() {
  ...
  const whyChoose = [
    {
      title: "Blazing Fast",
      desc: "Optimized rendering with Virtual DOM ensures lightning-fast performance.",
      icon: "⚡"
    },
    {
      title: "Scalable & Flexible",
      desc: "Easily scale your application as your business grows with React's flexibility.",
      icon: "📈"
    },
    {
      title: "SEO Friendly",
      desc: "React supports server-side rendering for better SEO and visibility.",
      icon: "🔍"
    },
    {
      title: "Component Reusability",
      desc: "Build reusable UI components that save time and ensure consistency.",
      icon: "🧩"
    },
    {
      title: "Developer Friendly",
      desc: "Simple syntax, powerful tools, and a huge ecosystem for developers.",
      icon: "💻"
    },
    {
      title: "Strong & Reliable",
      desc: "Backed by Meta and a large community for long-term reliability.",
      icon: "🛡️"
    }
  ];
  ...
  const services = [
    ...
    },
    {
      ...
      desc: "Pixel-perfect, responsive, and interactive UIs that provide exceptional user experience.",
      icon: "🎨"
    },
    {
      title: "Single Page Applications (SPA)",
      desc: "Fast, seamless, and dynamic SPAs with smooth navigation and performance.",
      icon: "📄"
    },
    {
      title: "API Integration",
      desc: "Integrate REST/GraphQL APIs securely to connect your app with any backend.",
      icon: "🔌"
    },
    {
      title: "React Migration",
      desc: "Migrate your existing application to React for better performance and scalability.",
      icon: "🔄"
    },
    {
      title: "Maintenance & Support",
      desc: "Ongoing support, updates, and optimization to keep your app running smoothly.",
      icon: "🛠️"
    }
  ];

  const techWeUse = [
    "React", "TypeScript", "JavaScript", "Next.js", "Redux", "Tailwind CSS", "Material UI", "Axios", "Firebase"
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">React Development</span>
          </nav>
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-text-base leading-[1.08] mb-6">
                ...
                <span className="text-primary underline decoration-primary/40 decoration-4 underline-offset-8">
                  Dynamic Experiences. Exceptional Performance.
                </span>
              </h1>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Component Based UI</span><span className="text-primary font-bold">Reusable & Scalable</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Virtual DOM</span><span className="text-primary font-bold">Fast Rendering</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>SEO Friendly</span><span className="text-primary">Next.js Ready</span>
                  </div>
                </div>

                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">State Management</span>
                    <span className="font-bold font-serif text-white mt-1">Status: Redux & Context API</span>
                  </div>
          ...
          <section className="py-8 border-t border-border-custom/25 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              ...
              <p className="text-xs md:text-sm text-text-muted leading-relaxed mt-4">
                React helps us build interactive UIs that are fast, maintainable, and easy to scale.
              </p>
            </div>
          ...
          <section className="py-8 border-t border-border-custom/25 pt-16 text-center">
            <h3 className="font-serif text-2xl font-bold text-text-base mb-8">Technologies We Use with React</h3>
