...
export default function LangChainDevelopmentPage() {
  const indicators = [
    { label: "Custom LLM Application Development" },
    { label: "Memory & Context Management" },
    { label: "RAG & Vector Store Integration" },
    { label: "Tool & API Integrations" },
    { label: "AI Agent & Workflow Automation" },
    { label: "Scalable & Production-Ready Solutions" },
  ];
  ...
  const whyChoose = [
    {
      title: "End-to-End LLM Application Building",
      desc: "Build complete LLM apps with chains, memory, tools, and agents.",
      icon: "🧠"
    },
    {
      title: "RAG Made Easy",
      desc: "Seamlessly connect with vector stores and retrieve real-time knowledge.",
      icon: "🗄️"
    },
    {
      title: "Flexible Integrations",
      desc: "Integrate models, prompts, APIs, databases, and external tools effortlessly.",
      icon: "🧩"
    },
    {
      title: "AI Agents & Tools",
      desc: "Create autonomous agents that can think, act, and use external tools.",
      icon: "🤖"
    },
    {
      title: "Memory & Context Management",
      desc: "Maintain conversation history and context for smarter interactions.",
      icon: "💾"
    },
    {
      title: "Scalable & Reliable",
      desc: "Production-ready architectures that scale with your business.",
      icon: "📈"
    }
  ];
  ...
  const services = [
    {
      ...
      desc: "Custom chatbots, copilots, and LLM-powered applications using LangChain.",
      icon: "💬"
    },
    {
      title: "RAG & Knowledge Solutions",
      desc: "Build Retrieval-Augmented Generation apps with accurate, up-to-date data.",
      icon: "📄"
    },
    {
      title: "AI Agent Development",
      desc: "Design and deploy intelligent agents that automate tasks and workflows.",
      icon: "🤖"
    },
    {
      title: "Workflow & Chain Design",
      desc: "Create advanced chains and workflows for complex business logic.",
      icon: "⚙️"
    },
    {
      title: "Tool & API Integration",
      desc: "Connect APIs, tools, and external services to extend LLM capabilities.",
      icon: "🔌"
    },
    {
      title: "Deployment & Optimization",
      desc: "Deploy, monitor, and optimize LangChain apps for peak performance.",
      icon: "🚀"
    }
  ];

  const techWeUse = [
    "LangChain", "OpenAI", "Python", "Pinecone", "Chroma", "FAISS", "PostgreSQL", "Streamlit", "Docker"
  ];

  const pillars = [
    "Expert LangChain Developers",
    "On-Time Delivery",
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">LangChain Development</span>
          </nav>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-7 flex flex-col items-start text-left">
              ...
              <h1 className="font-serif text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight text-text-base leading-[1.08] mb-6">
                LangChain Development <br />
                <span className="text-primary underline decoration-primary/40 decoration-4 underline-offset-8">
                  Build Smarter LLM Applications. Faster.
                </span>
              </h1>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Chatbots & Conversational AI</span><span className="text-primary font-bold">Enabled</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>RAG & Knowledge Retrieval</span><span className="text-primary font-bold">Vector Search Ready</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>AI Agents & Automation</span><span className="text-primary">Autonomous Tools</span>
                  </div>
                </div>

                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">Chain Orchestration</span>
                    <span className="font-bold font-serif text-white mt-1">Status: Modular, Scalable & Secure</span>
                  </div>
          ...
          <section className="py-8 border-t border-border-custom/25 pt-16">
            <div className="text-center max-w-2xl mx-auto mb-16">
              <h2 className="font-serif text-3xl md:text-5xl font-bold tracking-tight text-text-base mt-2">
                Why Choose LangChain for Your Project?
              </h2>
              <p className="text-xs md:text-sm text-text-muted leading-relaxed mt-4">
                LangChain makes it easy to build powerful, context-aware, and reliable LLM applications.
              </p>
            </div>
          ...
          {/* Technologies We Use with LangChain */}
          <section className="py-8 border-t border-border-custom/25 pt-16 text-center">
            <h3 className="font-serif text-2xl font-bold text-text-base mb-8">Technologies We Use with LangChain</h3>
