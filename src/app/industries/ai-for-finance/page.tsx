...
export default function AIFinancePage() {
  const indicators = [
    ...
    { label: "Reduce Risk & Fraud", icon: "🛡️" },
    { label: "Automate & Optimize", icon: "⚙️" },
    { label: "Delight Customers", icon: "👥" },
  ];

  const clientLogos = [
    "HDFC BANK", "ICICI Bank", "AXIS BANK", "Paytm payments bank", "motilal oswal", "ZERODHA"
  ];

  const solutions = [
    {
      title: "Fraud Detection & Prevention",
      desc: "Detect anomalies and fraudulent activities in real-time using AI/ML models.",
      icon: "🧠"
    },
    {
      title: "Risk Assessment & Management",
      desc: "AI-driven models to assess credit risk, market risk, and operational risk with greater accuracy.",
      icon: "📉"
    },
    {
      title: "Intelligent Automation",
      desc: "Automate KYC, document processing, reconciliations, and compliance tasks to improve efficiency.",
      icon: "🤖"
    },
    {
      title: "Algorithmic Trading & Forecasting",
      desc: "Leverage AI for predictive analytics and algorithmic strategies to maximize returns.",
      icon: "📈"
    },
    {
      title: "Customer Intelligence & Personalization",
      desc: "Understand customer behavior and deliver personalized financial experiences.",
      icon: "👤"
    },
    {
      title: "Financial Analytics & Reporting",
      desc: "Generate real-time insights, automated reports, and dashboards for better decision-making.",
      icon: "📄"
    }
  ];
  ...
  const useCases = [
    {
      ...
      desc: "Improve credit decisioning with AI-based credit scoring and approval systems.",
      icon: "🛡️"
    },
    {
      title: "Loan Underwriting",
      desc: "Automate underwriting with intelligent document analysis and risk scoring.",
      icon: "💳"
    },
    {
      title: "Transaction Monitoring",
      desc: "Monitor transactions in real-time to detect suspicious activities and reduce AML risk.",
      icon: "📲"
    },
    {
      title: "Wealth Management",
      desc: "AI-powered portfolio recommendations and wealth advisory for better outcomes.",
      icon: "📈"
    },
    {
      title: "Chatbots & Virtual Assistants",
      desc: "AI chatbots for 24/7 customer support and query resolution.",
      icon: "🎧"
    },
    {
      title: "Regulatory Compliance",
      desc: "Ensure compliance with AI-powered monitoring and automated reporting.",
      icon: "🏛️"
    }
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">AI for Finance</span>
          </nav>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Total Revenue Impact</span><span className="text-primary font-bold">₹ 28.7 Cr</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Cost Savings</span><span className="text-primary font-bold">₹ 10.3 Cr</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Fraud Detection</span><span className="text-primary">97.8% Accuracy</span>
                  </div>
                </div>

                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">Risk Score</span>
          ...
          <section className="py-4 border-y border-border-custom/15 text-center">
            <span className="text-[9px] font-mono font-bold text-text-muted uppercase tracking-widest block mb-6">Trusted by Leading Financial Brands</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center text-left">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                <h3 className="font-serif text-2xl md:text-4xl font-bold text-white mb-4 leading-tight">
                  ...
                  <span className="text-primary">Future with AI</span>
                </h3>
                <p className="text-xs md:text-sm text-white/70 mb-6 leading-relaxed max-w-lg">
                  Unlock the power of AI to reduce risk, improve efficiency, and deliver exceptional financial experiences.
                </p>
