...
export default function AIRetailPage() {
  const indicators = [
    { label: "Better Customer Experiences", icon: "🛒" },
    { label: "Data-Driven Decisions", icon: "📊" },
    { label: "Higher Sales & Profitability", icon: "📈" },
  ];

  const clientLogos = [
    "DMart", "TRENDS", "lifestyle", "Reliance Retail", "firstcry", "zepto", "bigbasket"
  ];

  const solutions = [
    {
      title: "Personalized Recommendations",
      desc: "AI-driven product recommendations that increase conversion and average order value.",
      icon: "🏷️"
    },
    {
      title: "Demand Forecasting",
      desc: "Predict demand accurately and optimize inventory to reduce stockouts and overstock.",
      icon: "📊"
    },
    {
      title: "Inventory Optimization",
      desc: "Real-time inventory insights to improve turnover, reduce costs, and maximize availability.",
      icon: "🎓"
    },
    {
      title: "Customer Segmentation",
      desc: "Segment customers based on behavior and preferences to run highly targeted campaigns.",
      icon: "👤"
    },
    {
      title: "Dynamic Pricing",
      desc: "AI-powered dynamic pricing to stay competitive and maximize margins.",
      icon: "🛒"
    },
    {
      title: "Store Analytics",
      desc: "Analyze footfall, in-store behavior, and sales performance for better decision making.",
      icon: "🏫"
    }
  ];
  ...
  const useCases = [
    {
      ...
      desc: "Increase cross-sell & up-sell by showing the right products.",
      icon: "🛍️"
    },
    {
      title: "Supply Chain & Inventory Management",
      desc: "AI optimizes stock levels and supplier planning for seamless operations.",
      icon: "📦"
    },
    {
      title: "Customer Loyalty & Retention",
      desc: "Reidentify at-risk customers and run personalized retention campaigns.",
      icon: "👥"
    },
    {
      title: "Smart Marketing Campaigns",
      desc: "Target the right audience with AI-driven campaigns for higher ROI.",
      icon: "📢"
    },
    {
      title: "Fraud Detection & Loss Prevention",
      desc: "Detect anomalies and prevent fraudulent activities in real-time.",
      icon: "🛡️"
    },
    {
      title: "Sales Performance Analytics",
      desc: "Get real-time insights into sales, categories, and store performance.",
      icon: "📈"
    }
  ];
      ...
      <div className="hog-grid min-h-screen pb-20 pt-10 text-left">
        <main className="max-w-none px-6 md:px-12 lg:px-16 flex flex-col gap-20 md:gap-28">
          ...
          <nav className="text-xs font-mono text-text-muted flex items-center gap-2 pt-8">
            ...
            <span>&gt;</span>
            <span className="text-text-base">AI for Retail</span>
          </nav>
              ...
              <div className="relative w-full max-w-[420px] aspect-[4/3] rounded-[24px] overflow-hidden border border-border-custom bg-neutral-900 shadow-2xl p-6 flex flex-col justify-between text-white/95">
                <div className="flex flex-col gap-3 font-mono text-[9px] text-white/60">
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Sales Overview</span><span className="text-primary font-bold">₹18.6 Cr</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Inventory Health</span><span className="text-primary font-bold">92% In Stock</span>
                  </div>
                  <div className="flex justify-between border-b border-white/5 pb-1">
                    <span>Demand Forecast</span><span className="text-primary">+28%</span>
                  </div>
                </div>

                <div className="bg-white/5 border border-white/5 p-3 rounded-xl flex justify-between items-center text-[10px] mt-4">
                  <div className="flex flex-col text-left">
                    <span className="text-white/40 uppercase tracking-widest font-mono">Customer Insights</span>
          ...
          <section className="py-4 border-y border-border-custom/15 text-center">
            <span className="text-[9px] font-mono font-bold text-text-muted uppercase tracking-widest block mb-6">Trusted by Leading Retail Brands</span>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center text-left">
              ...
              <div className="lg:col-span-7 flex flex-col items-start">
                <h3 className="font-serif text-2xl md:text-4xl font-bold text-white mb-4 leading-tight">
                  Let&apos;s Transform Your Retail <br />
                  <span className="text-primary">Business with AI</span>
                </h3>
                <p className="text-xs md:text-sm text-white/70 mb-6 leading-relaxed max-w-lg">
                  Whether you run a single store or a multi-chain retail brand, we can help you unlock the power of AI to grow faster and serve customers better.
                </p>
